...
| `type` (create/get/list/schema/update/delete) | S2; `type schema` `enum` for a `vocabularyRef`-backed select field (active terms only, `x-srs-vocabulary-terms`, srs-rust#1002) — S6 step 3a |
