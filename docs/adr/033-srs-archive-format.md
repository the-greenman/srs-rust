...
- **Date:** 2026-07-17
- **Supersedes:** —
- **Superseded by:** [ADR-039](039-srs-archive-pure-tree-zip.md) (items 8–9: the snapshot-driven content model and `package/package.snapshot.json`; determinism requirements remain in force)
