...
- The two initial migrations (`migrate-identity`, `repo-upgrade`) cover the cases the issue identified; further migrations (`migrate_rfc014`, `migrate packet`) are out of scope here and can be added as registry entries in future plans.
